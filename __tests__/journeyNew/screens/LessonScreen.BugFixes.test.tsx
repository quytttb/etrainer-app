...
jest.mock('../../../app/journeyNew/components/LessonContent/QuestionRenderer', () => {
     const mockReact = require('react');
     return function MockQuestionRenderer(props: any) {
          return mockReact.createElement('View', {
...
describe('LessonScreen - Bug Fixes Tests', () => {
     ...
     describe('(2) Câu hỏi có audio và image - Xử lý media', () => {
          ...
          it('should render AudioPlayer component for questions with audio content', async () => {
               ...
               const questionRenderer = await findByTestId('question-renderer');
