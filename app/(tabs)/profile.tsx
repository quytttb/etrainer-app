...
import { View, Text, StyleSheet, Switch, TouchableOpacity, ScrollView, Image, Alert, Button } from 'react-native';
...
export default function SettingsScreen() {
    ...
    const fetchUserData = async () => {
      try {
        ...
        if (userData) {
          ...
          setAvatar(parsedData.avatar || "https://example.com/default-avatar.png"); // Default avatar
        }
      } catch (error) {
  ...
  const handleSaveReminder = () => {
    if (isReminderEnabled) {
      Alert.alert('Nhắc nhở đã được lưu!', `Thời gian nhắc nhở: ${reminderTime.toLocaleString()}`);
    } else {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.settingsList}>
        ...
        <TouchableOpacity style={styles.settingItem} onPress={() => setShowDateTimePicker(true)}>
      ...
      {isReminderEnabled && (
        <View style={styles.settingItem}>
          <Text style={styles.settingText}>Chọn thời gian nhắc nhở học tập</Text>
